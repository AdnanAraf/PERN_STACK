      ...
      <div>
        <div>
          <div className="flex gap-[8px]">
            ...
            <div className="flex justify-between    border-[1px] border-[#FCCEEE] w-[93px] h-[24px] bg-[#FDF2FA]  rounded-2xl relative">
              <img
                className="h-[8px] w-[8px] top-[8px] absolute left-[8px]"
                src="https://i.ibb.co/LN4MQHm/Dot-3.png"
              ></img>
              <h6 className="text-[#C11574]   text-[14px] absolute top-[0px] left-[24px] font-medium">
                Software
              </h6>
            </div>
          </div>
