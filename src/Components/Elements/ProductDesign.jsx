  ...
  return (
    <div className="w-[768px] border-[1px] border-[#EAECF0] mt-[64px] container mx-auto p-[24px] rounded-2xl">
      <div className="flex justify-between">
        <div>
          <h6 className="text-[#3538CD] font-semibold text-[14px]">Design</h6>
        </div>
      ...
      <div>
        <div>
          <div className="flex gap-[8px]">
            ...
            <div className="flex justify-between    border-[1px] border-[#B2DDFF] w-[79px] h-[24px] bg-[#EFF8FF]  rounded-2xl relative">
              <img
                className="h-[8px] w-[8px] top-[8px] absolute left-[8px]"
                src="https://i.ibb.co/4ffbdND/Dot.png"
              ></img>
              <h6 className="text-[#3538CD]   text-[14px] absolute top-[0px] left-[20px] font-medium">
                Design
              </h6>
            </div>
          </div>
