      ...
      <div>
        <div>
          <div className="flex gap-[8px]">
            ...
            <div className="flex justify-between    border-[1px] border-[#F9DBAF] w-[100px] h-[24px] bg-[#FEF6EE]  rounded-2xl relative">
              <img
                className="h-[8px] w-[8px] top-[8px] absolute left-[8px]"
                src="https://i.ibb.co/wL6zGzN/Dot-1.png"
              ></img>
              <h6 className="text-[#B93815]   text-[14px] absolute top-[0px] left-[24px] font-medium">
                Marketing
              </h6>
            </div>
          </div>
